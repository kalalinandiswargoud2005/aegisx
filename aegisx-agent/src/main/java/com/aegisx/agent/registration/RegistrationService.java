package com.aegisx.agent.registration;

import com.aegisx.agent.database.AgentConfigRepository;
...
public class RegistrationService implements CommandLineRunner {
    ...
    public void run(String... args) {
        log.info("Starting AEGISX Agent Registration flow...");
        initializeDeviceId();
        registerWithBackend();
    }
    ...
    private void initializeDeviceId() {
        ...
        System.setProperty("aegisx.agent.id", this.deviceId);
    }
