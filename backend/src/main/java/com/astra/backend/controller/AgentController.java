...
public class AgentController {
    ...
    private final com.astra.backend.repository.DeviceCommandRepository commandRepository;
    ...
    public ResponseEntity<java.util.List<com.astra.backend.entity.DeviceCommand>> getPendingCommands(@PathVariable UUID deviceId) {
