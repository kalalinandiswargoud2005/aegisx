package com.astra.agent.collector;
...
public class TelemetryCollector {
    ...
    @Value("${astra.agent.id:unknown-device}")
    ...
    public TelemetryDto collectTelemetry() {
        ...
        String dynamicDeviceId = System.getProperty("astra.agent.id", deviceId);
