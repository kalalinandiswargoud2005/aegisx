...
import com.astra.backend.simulation.ThreatLibraryService;
...
public class ReportController {
    ...
    private final com.astra.backend.repository.IncidentReportRepository reportRepository;
    ...
    public ResponseEntity<byte[]> exportReports() throws Exception {
        ...
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=astra-report.json")
                .contentType(MediaType.APPLICATION_JSON)
                .body(jsonData);
    }

    @GetMapping("/incident/{incidentId}")
    public ResponseEntity<com.astra.backend.entity.IncidentReport> getIncidentReport(@org.springframework.web.bind.annotation.PathVariable java.util.UUID incidentId) {
