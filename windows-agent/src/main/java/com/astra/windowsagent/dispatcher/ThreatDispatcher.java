...
public class ThreatDispatcher {
    ...
    private final com.astra.windowsagent.communication.EventSender eventSender;

    public ThreatDispatcher(com.astra.windowsagent.communication.EventSender eventSender) {
