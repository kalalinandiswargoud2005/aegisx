package com.astra.agent.telemetry;

import com.astra.agent.collector.TelemetryCollector;
import com.astra.agent.dto.TelemetryDto;
...
public class HeartbeatService {
    ...
    private final com.astra.agent.database.TelemetryRepository telemetryRepository;

    @Scheduled(fixedRateString = "${astra.agent.heartbeat-interval:30000}")
    public void sendHeartbeat() {
        try {
            ...
            // Save to SQLite
            com.astra.agent.models.TelemetryCache cacheEntity = com.astra.agent.models.TelemetryCache.builder()
                    ...
                    .astraServiceStatus(telemetry.getAstraxServiceStatus())
