-- ==========================================
-- ASTRA Enterprise - Mock Data Injection
-- ==========================================
...
('00000000-0000-0000-0000-000000000001', 'admin@astra.com', 'System Admin', 'ADMIN'),
('00000000-0000-0000-0000-000000000002', 'analyst@astra.com', 'Security Analyst', 'ANALYST'),
('00000000-0000-0000-0000-000000000003', 'viewer@astra.com', 'Executive Viewer', 'VIEWER'),
('00000000-0000-0000-0000-000000000004', 'dev@astra.com', 'Lead Developer', 'DEVELOPER')
...
('10000000-0000-0000-0000-000000000004', 'ASTRA-PI-MASTER', 'RASPBERRY_PI', '192.168.1.200', 'ONLINE', 'GOOD', 'Debian 12', 'pi-core-1.5')
ON CONFLICT (id) DO NOTHING;
